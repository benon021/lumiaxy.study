  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 py-16 px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-4xl font-bold text-white tracking-tight">LinkedIn</h1>
        <p className="text-white/40 mt-3">Connect your official LinkedIn link here.</p>
      </motion.div>
      <div className="glass rounded-[32px] p-8 border border-white/10 text-white/50">
        Replace this page with a redirect to your real LinkedIn page when ready.
        <div className="mt-4">
