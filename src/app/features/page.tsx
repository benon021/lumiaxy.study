       ...
       <div className="max-w-6xl mx-auto px-4 lg:px-8 space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-16">
             ...
             <div className="glass p-8 rounded-[32px] border border-white/10">
                ...
                <p className="text-white/40 leading-relaxed">Teachers monitor student progress live. Educators can deploy trackable assignments natively via the platform and instantly dispatch numerical grades through the Grading Nexus.</p>
             </div>
          </div>
       </div>
       <Footer />
