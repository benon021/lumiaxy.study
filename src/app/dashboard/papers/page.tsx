...
export default function PastPapersPage() {
  ...
  const filteredPapers = papers.filter(paper => {
    ...
    const matchesSubject = filters.subject === "All Subjects" || paper.subject === filters.subject;
    const matchesYear = filters.year === "All Years" || paper.year === filters.year;
    const matchesDifficulty = filters.difficulty === "All Levels" || paper.difficulty === filters.difficulty;
